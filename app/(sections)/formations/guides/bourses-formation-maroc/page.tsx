  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        { name: "منح التكوين المهني في المغرب 2026", href: "/formations/guides/bourses-formation-maroc" }
      ]}
...
<p>التكوين المهني فالمغرب 2026 كايتطور بسرعة. الحكومة والمؤسسات الخاصة والعالمية كايتوفر منح (Bourses) للمغاربة باش يطورو مهاراتهم. هاد المنح كاتغطي من المصاريف الدراسية للسكن والمعيشة.</p>
        ...
        <h2>2. منح وزارة التربية الوطنية والتكوين المهني</h2>
        ...
        <h2>3. منح ANAPEC (وكالة التشغيل)</h2>
        ...
        <h2>5. منح Erasmus+ (الاتحاد الأوروبي)</h2>
        ...
        <h2>7. منح السفارات والمنظمات العالمية</h2>
        <ul>
        ...
        <h2>كيفاش تقدم على منحة بنجاح؟</h2>
        <ul>
        ...
        <h2>نموذج رسالة تحفيزية (Lettre de Motivation)</h2>
