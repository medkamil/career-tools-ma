...
export default function FormationsGuidePage() {
  ...
  <ArticleLayout
      ...
      breadcrumbs={[
        ...
        { name: "أفضل 10 تكوينات مهنية مطلوبة في المغرب 2026", href: "/formations/guides/meilleures-formations-maroc-2026" }
      ]}
      title="أفضل 10 تكوينات مهنية مطلوبة في المغرب 2026 (OFPPT + تكوينات مجانية)"
    ...
    >
        ...
        <h2>1. Développement Web et Mobile</h2>
        <p>
        ...
        <h2>2. Marketing Digital et Social Media</h2>
        <p>
        ...
        <h2>4. Comptabilité et Gestion</h2>
        <p>
        ...
        <h2>5. Infirmier et Soins de Santé</h2>
        <p>
        ...
        <h2>6. Électricité et Énergies Renouvelables</h2>
        <p>
        ...
        <h2>7. Hôtellerie et Tourisme</h2>
        <p>
        ...
        <h2>8. Logistique et Transport</h2>
        <p>
        ...
        <h2>10. Artisanat et Métiers Traditionnels</h2>
        <p>
        ...
        <h2>تكوينات مجانية بشهادات معتمدة</h2>
        <p>
