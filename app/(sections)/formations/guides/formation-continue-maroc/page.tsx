...
export const metadata: Metadata = {
  title: "التدريب المستمر للعاملين في المغرب 2026 (دليل كامل) | Tawdif Pro",
  description: "دليل التدريب المستمر للعاملين في المغرب 2026. برامج التكوين المستمر، الشروط، التمويل، وأفضل المؤسسات.",
};
