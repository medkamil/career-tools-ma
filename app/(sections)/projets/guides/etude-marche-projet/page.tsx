  ...
  return (
    <ArticleLayout
      ...
      breadcrumbs={[
        ...
        { name: "الدراسة السوقية للمشروع في المغرب 2026", href: "/projets/guides/etude-marche-projet" }
      ]}
...
<p>الدراسة السوقية (Étude de marché) هي الأساس لأي مشروع ناجح. قبل ما تبدأ مشروعك، خاصك تعرف واش السوق كاين، شنو باغي الزبناء، شنو كايدير المنافسون. فالمغرب 2026، الدراسة السوقية هي شرط أساسي فجميع برامج الدعم (Forsa, INTELAKA) وحتى القروض البنكية.</p>
        ...
        <h2>الخطوة 1: تحديد هدف الدراسة</h2>
        ...
        <h2>الخطوة 2: تحليل السوق (Analyse du Marché)</h2>
        ...
        <h2>الخطوة 3: تحليل الطلب (Analyse de la Demande)</h2>
        ...
        <h2>الخطوة 4: تحليل العرض والمنافسة (Analyse de l&apos;Offre)</h2>
        ...
        <h2>الخطوة 6: الاستراتيجية المقترحة</h2>
        ...
        <h2>أدوات مجانية للدراسة السوقية فالمغرب</h2>
        <ul>
        ...
        <h2>نموذج مبسط لدراسة السوق (لبرامج الدعم)</h2>
        ...
        <h2>الأخطاء الشائعة ف الدراسة السوقية</h2>
        <ul>
