...
export const metadata: Metadata = {
  title: "نصائح اجتياز مقابلة العمل في المغرب 2026 (دليلك الكامل) | Tawdif Pro",
  description: "دليل شامل لاجتياز مقابلة العمل في المغرب 2026. أسئلة متوقعة، لباس مناسب، لغة الجسد، والمتابعة. نصائح عملية للنجاح.",
};
