...
export default function CVGuidePage() {
  ...
  <ArticleLayout
      schemas={schemas}
      breadcrumbs={[
        { name: "الرئيسية", href: "/emplois" },
        { name: "كيفاش تكتب CV احترافي في المغرب 2026", href: "/emplois/guides/cv-professionnel-maroc-2026" }
      ]}
      title="كيفاش تكتب CV احترافي في المغرب 2026 (نماذج + نصائح ذهبية)"
    ...
    >
        ...
        <h2>1. قبل ما تبدا… شنو هو الهدف ديال CV؟</h2>
        <p>
        ...
        <h2>2. المعلومات الشخصية — شنو تحط وشنو لا</h2>
        <p>
        ...
        <h2>3. L'expérience professionnelle — كيفاش تعرضها</h2>
        <p>
        ...
        <h2>5. Compétences — المهارات التقنية والشخصية</h2>
        <p>
        ...
        <h2>7. Photo professionnelle — واش ضروري؟</h2>
        <p>
        ...
        <h2>8. Les erreurs à éviter ف CV</h2>
        <p>
        ...
        <h2>10. كيفاش تحسن فرصك فالبحث على الخدمة؟</h2>
        <p>
