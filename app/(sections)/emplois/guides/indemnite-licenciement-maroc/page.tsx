...
export const metadata: Metadata = {
  title: "تعويض نهاية الخدمة (الطرد) في المغرب 2026: طريقة الحساب الكاملة | Tawdif Pro",
  description: "طريقة حساب تعويض نهاية الخدمة في المغرب 2026. حالات الاستحقاق، الشروط القانونية، جدول التعويضات حسب الأقدمية، وكيفية المطالبة بحقوقك القانونية.",
};
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
      ...
      <nav className="mb-6 text-sm text-gray-500">
        ...
        {" > "}
        <span className="text-gray-900">تعويض نهاية الخدمة فالمغرب</span>
      </nav>
      <header className="mb-10 text-center">
        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl leading-tight">تعويض نهاية الخدمة (الطرد) في المغرب 2026: طريقة الحساب الكاملة</h1>
      ...
      <div className="space-y-6 text-base leading-8 text-gray-800">
        ...
        <h2 className="text-2xl font-bold text-gray-900">1. شنو هو تعويض نهاية الخدمة (Indemnite de Licenciement)؟</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-900">2. شروط استحقاق التعويض</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-900">3. طريقة حساب التعويض بالتفصيل 2026</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-900">4. الإجراءات القانونية للمطالبة بالحقوق</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-900">5. الحالات لي ما كاتستحقش فيها التعويض</h2>
        <ul className="list-disc space-y-2 pr-6">
      ...
      <div className="mt-8 rounded-xl bg-gray-50 p-4">
        <p className="text-sm text-gray-600">
          {"اقرا أيضا: "}
          <Link href="/emplois/guides/cv-professionnel-maroc-2026" className="text-emerald-600 underline hover:text-emerald-800">حقوق الأجير في القانون المغربي</Link>
          {" | "}
