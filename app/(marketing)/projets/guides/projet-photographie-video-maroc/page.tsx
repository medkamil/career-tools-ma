...
export const metadata: Metadata = {
  title: "مشروع التصوير الفوتوغرافي والفيديو في المغرب 2026 | Tawdif Pro",
  description:
    "دليل كامل لمشروع التصوير الفوتوغرافي والفيديو (photographie et vidéo) في المغرب: التجهيزات، التكاليف، stratégie marketing، التراخيص، والأرباح المتوقعة. كل ما تحتاج لبدء مشروع تصوير ناجح.",
};
