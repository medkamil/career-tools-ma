...
export const metadata: Metadata = {
  title: "مشروع الزراعة في البيوت المغطاة (Serre) في المغرب 2026 | Tawdif Pro",
  description:
    "دليل كامل لمشروع الزراعة في البيوت المغطاة (agriculture sous serre) في المغرب: أنواع البيوت، التكاليف، المحاصيل الأكثر ربحاً، والأرباح المتوقعة. دراسة جدوى شاملة.",
};
