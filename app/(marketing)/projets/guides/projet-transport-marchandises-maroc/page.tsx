...
export const metadata: Metadata = {
  title: "مشروع نقل البضائع في المغرب: شروط وتراخيص 2026 | Tawdif Pro",
  description:
    "دليل متكامل لمشروع نقل البضائع في المغرب: شروط الحصول على التراخيص، أنواع المركبات، تكاليف التأسيس، وأرباح نقل البضائع. Transport de marchandises خطوة بخطوة.",
};
