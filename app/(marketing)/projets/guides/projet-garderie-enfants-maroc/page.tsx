...
export const metadata: Metadata = {
  title: "مشروع حضانة الأطفال (Crèche) في المغرب: دليل كامل 2026 | Tawdif Pro",
  description:
    "دليل شامل لمشروع حضانة الأطفال (crèche) في المغرب: الشروط القانونية، التراخيص، التجهيزات، التكاليف، والأرباح المتوقعة. كل ما تحتاج لبدء مشروع garderie d'enfants ناجح.",
};
